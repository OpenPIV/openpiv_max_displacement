...
for f in frequencies:
    for d in densities:      
        for U in voltages:
            ...
            for velocity in velocities:
                FOL_IN = base_folder+"Results_PIV_100-88_S2N1.25/Open_PIV_results_/"
 ...
 #----------------------------------------------------------------------------------------------------------------               
                ...
                # for ro in range(10,int(77.5/0.6),5):
                for ro in range(10,11,1):
                    # Row = np.around(77.5-0.6*ro,1)   
                    Row = 53.5
                    # Depth = np.around(77.5-Row,1)
                    Depth = 24
                    print (ro, Row, Depth)
...
# ----------------------------------------------------------------------------------------------------------------
                    ...
                    plt.savefig(FOL_OUT_plots+"/"+U+"V_"+velocity+"_mmps_"+str(Depth)+"_mm_(100-88).PNG")
